...
if __name__=="__main__":
    ...
    os.system("gcc ./main.c ./readTables.c ./utils.c ./boundary.c ./solver.c ./sa.c ./saCC.c ./implicit.c ./limiter.c ./laminar.c ./sst.c ./sstTrans.c ./gasprop.c ./mesh.c ./input.c ./flux.c ./shockTube.c -o ./executable -lm -fopenmp -Wall -O3")
