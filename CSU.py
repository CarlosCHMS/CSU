...
if __name__=="__main__":
    ...
    os.system("gcc ./readTables.c ./utils.c ./mesh.c ./input.c boundary.c ./solver.c ./flux.c ./sa.c ./saCC.c ./implicit.c ./gasprop.c ./limiter.c ./main.c -o ./executable -lm -fopenmp -Wall -O3")
